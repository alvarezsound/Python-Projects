...
def load_gui(self):
    ...
    self.lbl_fname = tk.Label(self.master,text='First Name:', fg='black', bg='#a88d32')
    self.lbl_fname.grid(row=0,column=0,padx=(30,0),pady=(10,0),sticky=N+W)
    self.lbl_lname = tk.Label(self.master,text='Last Name:', fg='black', bg='#a88d32')
    self.lbl_lname.grid(row=2,column=0,padx=(30,0),pady=(10,0),sticky=N+W)
    self.lbl_phone = tk.Label(self.master,text='Phone Number:', fg='black', bg='#a88d32')
    self.lbl_phone.grid(row=4,column=0,padx=(30,0),pady=(10,0),sticky=N+W)
    self.lbl_email = tk.Label(self.master,text='Email Address:', fg='black', bg='#a88d32')
    self.lbl_email.grid(row=6,column=0,padx=(30,0),pady=(10,0),sticky=N+W)
    self.lbl_email = tk.Label(self.master,text='Current Course:', fg='black', bg='#a88d32')
    self.lbl_email.grid(row=8,column=0,padx=(30,0),pady=(10,0),sticky=N+W)
    self.lbl_info = tk.Label(self.master,text='Information:', fg='black', bg='#a88d32')
    ...
    self.btn_add = tk.Button(self.master,width=12,height=2,text='Submit',command=lambda: student_tracker_func.addToList(self))
